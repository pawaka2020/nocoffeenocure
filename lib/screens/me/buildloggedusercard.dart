...
Widget buildLoggedUserCard(BuildContext context, int currentPoints, int totalPoints, void Function() func) {
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              InkWell(
                onTap: () async {
                  bool confirmation = await showLogoffConfirmationDialog(
                      context);
                  if (confirmation) { }
                },
                child: Text(
...
Future<bool> showLogoffConfirmationDialog(BuildContext context) async {
